...
from naaspy import swanctl, config
...
# curl  -i -H "Content-Type: application/json" -X POST -d @naas-lk/del.json 127.0.0.1:5000/api/v1.0/config/del
...
# curl -i -X GET --cookie "auth=..." "127.0.0.1:5000/api/v1.0/config/list?user=magnit"
...
def main():
	...
	ap.add_argument("--version", action='store_true', help="Print NAAS build version")
